      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Zustand (@statesync/zustand)', link: '/api/zustand/' },
            { text: 'Valtio (@statesync/valtio)', link: '/api/valtio/' },
            { text: 'Svelte (@statesync/svelte)', link: '/api/svelte/' },
            { text: 'Vue (@statesync/vue)', link: '/api/vue/' },
